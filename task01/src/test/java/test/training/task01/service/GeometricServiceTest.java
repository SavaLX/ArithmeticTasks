...
public class GeometricServiceTest {
    ...
    public Object[][] createDataForHeightTriangle() {
        return new Object[][]{
                {new double[]{2}, 1.73205081},
                {new double[]{1}, 0.866025404},
                {new double[]{12}, 10.3923049},
        };
    }

    @Test(description = "check for counting the height of triangle", dataProvider = "dataForCountHeightOfTriangle")
    ...
    @Test(description = "check for counting the inscribed circle radius of triangle", dataProvider = "dataForCountInscribedCircleRadiusOfTriangle")
    ...
    public Object[][] createForCountCircumscribedCircleRadiusOfTriangle() {
        return new Object[][]{
                ...
                {new double[]{1}, 0.577350269},
                {new double[]{12}, 6.92820323},
        };
    }

    @Test(description = "check for counting the circumscribed circle radius of triangle", dataProvider = "dataForCountCircumscribedCircleRadiusOfTriangle")
